...
public abstract class SupervisedLearner {
	...
	// THIS HAD TO BE CHANGED IN ORDER TO ALLOW FOR THE VALIDATION DATA SET TO BE VISIBLE TO TRAINING
	// TO CALCULATE VALIDATION MSE OVER SAME TIME INTERVAL
	public abstract void train(Matrix features, Matrix labels, Matrix testFeatures, Matrix testLabels, Matrix confusion) throws Exception;
